...
class PuzzleState(object):
    ...
    def move_up(self):
        ...
        if pos in (0, 1, 2):
            ...
            newPuzzle=PuzzleState(self.move_up(),config=new_val)
            return newPuzzle
    ...
    def move_down(self):
        ...
        if pos in (6, 7, 8):
            ...
            new_val = list(self.config)
            new_val[pos], new_val[pos + 3] = new_val[pos + 3], new_val[pos]
            newPuzzle = PuzzleState(self.move_down(), config=new_val)
            return newPuzzle
    ...
    def move_left(self):
        ...
        if pos in (0, 3, 6):
            ...
            newPuzzle = PuzzleState(self.move_left, config=new_val)
            return newPuzzle
    ...
    def move_right(self):
        ...
        if pos in (2, 5, 8):
            ...
            new_val = list(self.config)
            new_val[pos], new_val[pos + 1] = new_val[pos + 1], new_val[pos]
            newPuzzle=PuzzleState(self.move_right(),config=new_val)
            return newPuzzle
...
def writeOutput():
    ...
    file.write("\nsearch_depth: " + str( GoalNode goal_node.depth))
...
def test_goal(puzzle_state):
    ...
    ### STUDENT CODE GOES HERE ###
    return str(puzzle_state) == str(range(0, 9))
...
def main():
    ...
    print(hard_state.config[1].parent)
